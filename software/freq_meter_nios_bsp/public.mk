...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../frequency_meter_Nios_display.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Nios_display_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Nios_display_system
SOPC_NAME := Nios_display_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11010b8
SOPC_SYSID_FLAG += --sidp=0x11010b8
ELF_PATCH_FLAG  += --sidp 0x11010b8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1598707242
SOPC_SYSID_FLAG += --timestamp=1598707242
ELF_PATCH_FLAG  += --timestamp 1598707242

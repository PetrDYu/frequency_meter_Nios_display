...
module Nios_display_system_mm_interconnect_0 (
		...
		output wire [1:0]  freq_en_s1_address,                             //                               freq_en_s1.address
		output wire        freq_en_s1_write,                               //                                         .write
		input  wire [31:0] freq_en_s1_readdata,                            //                                         .readdata
		output wire [31:0] freq_en_s1_writedata,                           //                                         .writedata
		output wire        freq_en_s1_chipselect,                          //                                         .chipselect
	...
	wire  [14:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> key_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> led_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> freq_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> lcd_data_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> lcd_rs_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> lcd_rw_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> lcd_e_s1_agent:cp_channel
	...
	wire  [31:0] freq_en_s1_agent_m0_readdata;                                                       // freq_en_s1_translator:uav_readdata -> freq_en_s1_agent:m0_readdata
	wire         freq_en_s1_agent_m0_waitrequest;                                                    // freq_en_s1_translator:uav_waitrequest -> freq_en_s1_agent:m0_waitrequest
	wire         freq_en_s1_agent_m0_debugaccess;                                                    // freq_en_s1_agent:m0_debugaccess -> freq_en_s1_translator:uav_debugaccess
	wire  [19:0] freq_en_s1_agent_m0_address;                                                        // freq_en_s1_agent:m0_address -> freq_en_s1_translator:uav_address
	wire   [3:0] freq_en_s1_agent_m0_byteenable;                                                     // freq_en_s1_agent:m0_byteenable -> freq_en_s1_translator:uav_byteenable
	wire         freq_en_s1_agent_m0_read;                                                           // freq_en_s1_agent:m0_read -> freq_en_s1_translator:uav_read
	wire         freq_en_s1_agent_m0_readdatavalid;                                                  // freq_en_s1_translator:uav_readdatavalid -> freq_en_s1_agent:m0_readdatavalid
	wire         freq_en_s1_agent_m0_lock;                                                           // freq_en_s1_agent:m0_lock -> freq_en_s1_translator:uav_lock
	wire  [31:0] freq_en_s1_agent_m0_writedata;                                                      // freq_en_s1_agent:m0_writedata -> freq_en_s1_translator:uav_writedata
	wire         freq_en_s1_agent_m0_write;                                                          // freq_en_s1_agent:m0_write -> freq_en_s1_translator:uav_write
	wire   [2:0] freq_en_s1_agent_m0_burstcount;                                                     // freq_en_s1_agent:m0_burstcount -> freq_en_s1_translator:uav_burstcount
	wire         freq_en_s1_agent_rf_source_valid;                                                   // freq_en_s1_agent:rf_source_valid -> freq_en_s1_agent_rsp_fifo:in_valid
	wire  [98:0] freq_en_s1_agent_rf_source_data;                                                    // freq_en_s1_agent:rf_source_data -> freq_en_s1_agent_rsp_fifo:in_data
	wire         freq_en_s1_agent_rf_source_ready;                                                   // freq_en_s1_agent_rsp_fifo:in_ready -> freq_en_s1_agent:rf_source_ready
	wire         freq_en_s1_agent_rf_source_startofpacket;                                           // freq_en_s1_agent:rf_source_startofpacket -> freq_en_s1_agent_rsp_fifo:in_startofpacket
	wire         freq_en_s1_agent_rf_source_endofpacket;                                             // freq_en_s1_agent:rf_source_endofpacket -> freq_en_s1_agent_rsp_fifo:in_endofpacket
	wire         freq_en_s1_agent_rsp_fifo_out_valid;                                                // freq_en_s1_agent_rsp_fifo:out_valid -> freq_en_s1_agent:rf_sink_valid
	wire  [98:0] freq_en_s1_agent_rsp_fifo_out_data;                                                 // freq_en_s1_agent_rsp_fifo:out_data -> freq_en_s1_agent:rf_sink_data
	wire         freq_en_s1_agent_rsp_fifo_out_ready;                                                // freq_en_s1_agent:rf_sink_ready -> freq_en_s1_agent_rsp_fifo:out_ready
	wire         freq_en_s1_agent_rsp_fifo_out_startofpacket;                                        // freq_en_s1_agent_rsp_fifo:out_startofpacket -> freq_en_s1_agent:rf_sink_startofpacket
	wire         freq_en_s1_agent_rsp_fifo_out_endofpacket;                                          // freq_en_s1_agent_rsp_fifo:out_endofpacket -> freq_en_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_012_src_valid;                                                              // cmd_mux_012:src_valid -> freq_en_s1_agent:cp_valid
	wire  [97:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> freq_en_s1_agent:cp_data
	wire         cmd_mux_012_src_ready;                                                              // freq_en_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire  [14:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> freq_en_s1_agent:cp_channel
	wire         cmd_mux_012_src_startofpacket;                                                      // cmd_mux_012:src_startofpacket -> freq_en_s1_agent:cp_startofpacket
	wire         cmd_mux_012_src_endofpacket;                                                        // cmd_mux_012:src_endofpacket -> freq_en_s1_agent:cp_endofpacket
	...
	wire  [14:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> time_del_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> freq_base_s1_agent:cp_channel
	...
	wire         freq_en_s1_agent_rp_valid;                                                          // freq_en_s1_agent:rp_valid -> router_014:sink_valid
	wire  [97:0] freq_en_s1_agent_rp_data;                                                           // freq_en_s1_agent:rp_data -> router_014:sink_data
	wire         freq_en_s1_agent_rp_ready;                                                          // router_014:sink_ready -> freq_en_s1_agent:rp_ready
	wire         freq_en_s1_agent_rp_startofpacket;                                                  // freq_en_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire         freq_en_s1_agent_rp_endofpacket;                                                    // freq_en_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire  [14:0] router_src_channel;                                                                 // router:src_channel -> nios2_gen2_0_data_master_limiter:cmd_sink_channel
	...
	wire  [14:0] nios2_gen2_0_data_master_limiter_cmd_src_channel;                                   // nios2_gen2_0_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [14:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_gen2_0_data_master_limiter:rsp_sink_channel
	...
	wire  [14:0] nios2_gen2_0_data_master_limiter_rsp_src_channel;                                   // nios2_gen2_0_data_master_limiter:rsp_src_channel -> nios2_gen2_0_data_master_agent:rp_channel
	...
	wire  [14:0] nios2_gen2_0_data_master_limiter_cmd_valid_data;                                    // nios2_gen2_0_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire         freq_en_s1_agent_rdata_fifo_src_valid;                                              // freq_en_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire  [33:0] freq_en_s1_agent_rdata_fifo_src_data;                                               // freq_en_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire         freq_en_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_012:in_0_ready -> freq_en_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_012_out_0_valid;                                                  // avalon_st_adapter_012:out_0_valid -> freq_en_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_012_out_0_data;                                                   // avalon_st_adapter_012:out_0_data -> freq_en_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_012_out_0_ready;                                                  // freq_en_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire   [0:0] avalon_st_adapter_012_out_0_error;                                                  // avalon_st_adapter_012:out_0_error -> freq_en_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) freq_en_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (freq_en_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (freq_en_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (freq_en_s1_agent_m0_read),                       //                         .read
		.uav_write              (freq_en_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (freq_en_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (freq_en_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (freq_en_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (freq_en_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (freq_en_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (freq_en_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (freq_en_s1_agent_m0_debugaccess),                //                         .debugaccess
		.av_address             (freq_en_s1_address),                             //      avalon_anti_slave_0.address
		.av_write               (freq_en_s1_write),                               //                         .write
		.av_readdata            (freq_en_s1_readdata),                            //                         .readdata
		.av_writedata           (freq_en_s1_writedata),                           //                         .writedata
		.av_chipselect          (freq_en_s1_chipselect),                          //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (freq_en_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (freq_en_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (freq_en_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (freq_en_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (freq_en_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (freq_en_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (freq_en_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (freq_en_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (freq_en_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (freq_en_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (freq_en_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (freq_en_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (freq_en_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (freq_en_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (freq_en_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (freq_en_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (freq_en_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (freq_en_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (freq_en_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (freq_en_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (freq_en_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (freq_en_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (freq_en_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (freq_en_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (freq_en_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (freq_en_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_012_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_012_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_012_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_012_out_0_error),              //                .error
		.rdata_fifo_src_ready    (freq_en_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (freq_en_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (freq_en_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) freq_en_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (freq_en_s1_agent_rf_source_data),                //        in.data
		.in_valid          (freq_en_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (freq_en_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (freq_en_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (freq_en_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (freq_en_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (freq_en_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (freq_en_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (freq_en_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (freq_en_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	Nios_display_system_mm_interconnect_0_router_003 router_014 (
		.sink_ready         (freq_en_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (freq_en_s1_agent_rp_valid),                      //          .valid
		.sink_data          (freq_en_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (freq_en_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (freq_en_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_display_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (freq_en_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (freq_en_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (freq_en_s1_agent_rdata_fifo_src_ready),          //         .ready

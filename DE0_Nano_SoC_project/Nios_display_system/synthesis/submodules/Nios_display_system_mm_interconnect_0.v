...
module Nios_display_system_mm_interconnect_0 (
	...
	wire  [98:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [98:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // onchip_memory2_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire  [12:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [98:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> key_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // key_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [12:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> key_s1_agent:cp_channel
	...
	wire  [98:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> led_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // led_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [12:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> led_s1_agent:cp_channel
	...
	wire  [20:0] freq_s1_agent_m0_address;                                                           // freq_s1_agent:m0_address -> freq_s1_translator:uav_address
	...
	wire  [99:0] freq_s1_agent_rf_source_data;                                                       // freq_s1_agent:rf_source_data -> freq_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] freq_s1_agent_rsp_fifo_out_data;                                                    // freq_s1_agent_rsp_fifo:out_data -> freq_s1_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> freq_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // freq_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [12:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> freq_s1_agent:cp_channel
	...
	wire  [98:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> sw_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // sw_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [12:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [20:0] lcd_data_s1_agent_m0_address;                                                       // lcd_data_s1_agent:m0_address -> lcd_data_s1_translator:uav_address
	...
	wire  [99:0] lcd_data_s1_agent_rf_source_data;                                                   // lcd_data_s1_agent:rf_source_data -> lcd_data_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] lcd_data_s1_agent_rsp_fifo_out_data;                                                // lcd_data_s1_agent_rsp_fifo:out_data -> lcd_data_s1_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> lcd_data_s1_agent:cp_data
	...
	wire  [20:0] lcd_rs_s1_agent_m0_address;                                                         // lcd_rs_s1_agent:m0_address -> lcd_rs_s1_translator:uav_address
	...
	wire  [99:0] lcd_rs_s1_agent_rf_source_data;                                                     // lcd_rs_s1_agent:rf_source_data -> lcd_rs_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] lcd_rs_s1_agent_rsp_fifo_out_data;                                                  // lcd_rs_s1_agent_rsp_fifo:out_data -> lcd_rs_s1_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> lcd_rs_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                              // lcd_rs_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [12:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> lcd_rs_s1_agent:cp_channel
	...
	wire  [20:0] lcd_rw_s1_agent_m0_address;                                                         // lcd_rw_s1_agent:m0_address -> lcd_rw_s1_translator:uav_address
	...
	wire  [99:0] lcd_rw_s1_agent_rf_source_data;                                                     // lcd_rw_s1_agent:rf_source_data -> lcd_rw_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] lcd_rw_s1_agent_rsp_fifo_out_data;                                                  // lcd_rw_s1_agent_rsp_fifo:out_data -> lcd_rw_s1_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> lcd_rw_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                              // lcd_rw_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [12:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> lcd_rw_s1_agent:cp_channel
	...
	wire  [20:0] lcd_e_s1_agent_m0_address;                                                          // lcd_e_s1_agent:m0_address -> lcd_e_s1_translator:uav_address
	...
	wire  [99:0] lcd_e_s1_agent_rf_source_data;                                                      // lcd_e_s1_agent:rf_source_data -> lcd_e_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] lcd_e_s1_agent_rsp_fifo_out_data;                                                   // lcd_e_s1_agent_rsp_fifo:out_data -> lcd_e_s1_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> lcd_e_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                              // lcd_e_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [12:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> lcd_e_s1_agent:cp_channel
	...
	wire  [20:0] freq_en_s1_agent_m0_address;                                                        // freq_en_s1_agent:m0_address -> freq_en_s1_translator:uav_address
	...
	wire  [99:0] freq_en_s1_agent_rf_source_data;                                                    // freq_en_s1_agent:rf_source_data -> freq_en_s1_agent_rsp_fifo:in_data
	...
	wire  [99:0] freq_en_s1_agent_rsp_fifo_out_data;                                                 // freq_en_s1_agent_rsp_fifo:out_data -> freq_en_s1_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> freq_en_s1_agent:cp_data
	wire         cmd_mux_012_src_ready;                                                              // freq_en_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire  [12:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> freq_en_s1_agent:cp_channel
	...
	wire  [98:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [98:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [98:0] key_s1_agent_rp_data;                                                               // key_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [98:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [98:0] freq_s1_agent_rp_data;                                                              // freq_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [98:0] sw_s1_agent_rp_data;                                                                // sw_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [98:0] lcd_data_s1_agent_rp_data;                                                          // lcd_data_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [98:0] lcd_rs_s1_agent_rp_data;                                                            // lcd_rs_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [98:0] lcd_rw_s1_agent_rp_data;                                                            // lcd_rw_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [98:0] lcd_e_s1_agent_rp_data;                                                             // lcd_e_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [98:0] freq_en_s1_agent_rp_data;                                                           // freq_en_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [98:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_003:sink1_data
	...
	wire  [98:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> rsp_mux_001:sink2_data

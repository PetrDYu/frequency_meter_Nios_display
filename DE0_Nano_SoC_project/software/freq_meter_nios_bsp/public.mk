...
# setting SOPC_SYSID_BASE_ADDRESS is 0x810b8
SOPC_SYSID_FLAG += --sidp=0x810b8
ELF_PATCH_FLAG  += --sidp 0x810b8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1601970550
SOPC_SYSID_FLAG += --timestamp=1601970550
ELF_PATCH_FLAG  += --timestamp 1601970550
